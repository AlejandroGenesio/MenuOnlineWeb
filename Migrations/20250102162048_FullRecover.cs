...
{
    /// <inheritdoc />
    public partial class FullRecover : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OptionsGroup = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    GroupStyle = table.Column<int>(type: "int", nullable: false),
                    GroupStyleClosed = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotesToPrint = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SellMinOptions = table.Column<int>(type: "int", nullable: true),
                    SellMinPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true)
                },
                constraints: table =>
                {
